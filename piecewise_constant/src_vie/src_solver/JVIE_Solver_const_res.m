function [Je,flag,relres,iter,resvec,solvert] = JVIE_Solver_const_res(Einc,e_r,r,freq,fN,tol,form,solver,precond,max_it,inner_it,outer_it,ritz,gpu_flag,logfile)
