function [Jout,Sout,Eout,Bout,Gsar,Pabs,fN,fK] = Scat_Solver(Einc,Hinc,freq,r,epsilon_r,sigma_e,fN,fK,rho, tol, form,solver,precond,max_it,inner_it,outer_it,ritz,gpu_flag,logfile)
...
t1 = tic;
        ...
        [Jout,~,~,~,~,~] = JVIE_Solver_const(Einc,e_r,r,freq,fN,tol,form,solver,precond,max_it,inner_it,outer_it,ritz,gpu_flag,logfile);
