function [Je,flag,relres,iter,resvec,solvert,vsol] = JVIE_Solver_const(Einc,e_r,r,freq,fN,tol,form,solver,precond,max_it,inner_it,outer_it,ritz,gpu_flag,logfile)
