function [JOut] = mv_A_const(JIn, fN, fK, Mer, Mce, Mmr, Mcm, Gram, ce, cm, transp_flag, idx, GPU_flag)
...
if strcmp(transp_flag,'transp')    
    ...
    [JeOut] = mv_AN_const(Je, fN, Mer, Mce, Gram, 'transp', idx, GPU_flag) - mv_AK_const(Je, fK, Mcm, cm, 'transp', idx, GPU_flag);
    [JmOut] = mv_AK_const(Jm, fK, Mce, ce, 'transp', idx, GPU_flag)        + mv_AN_const(Jm, fN, Mmr, Mcm, Gram, 'transp', idx, GPU_flag);
    
else
    
    [JeOut] =  mv_AN_const(Je, fN, Mer, Mce, Gram, 'notransp', idx, GPU_flag) + mv_AK_const(Jm, fK, Mce, ce, 'notransp', idx, GPU_flag);
    [JmOut] = -mv_AK_const(Je, fK, Mcm, cm, 'notransp', idx, GPU_flag)        + mv_AN_const(Jm, fN, Mmr, Mcm, Gram, 'notransp', idx, GPU_flag);
