function [JOut] = mv_N_const_with_zeros(JIn0, fN, r, idx, GPU_flag)
%%   M-V product of operator N via FFT
% _________________________________________________________________________
%
%       Applies the N operator to a current vector
%
% _________________________________________________________________________
%
%% INPUT
