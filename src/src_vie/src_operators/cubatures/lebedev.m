function [w, azimuth, inclination] = lebedev(degree)
%   azimuth (phi)       in [0,2pi]
%   inclination (theta) in [0,pi]
...
[azimuth,inclination,~] = cart2sph(x,y,z);
inclination = pi/2-inclination;

for n=1:size(azimuth)
    if azimuth(n)<0
        azimuth(n) = 2*pi + azimuth(n);
    end
end
...
switch (degree)
    ...
    case 1202
        ...
        [leb_tmp start] = getLebedevReccurencePoints(6,start,a,b,v,leb_tmp); %#ok<*NASGU>
    ...
    case 1730
        ...
        [leb_tmp start] = getLebedevReccurencePoints(6,start,a,b,v,leb_tmp); %#ok<*NCOMMA>
