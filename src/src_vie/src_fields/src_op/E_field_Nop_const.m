function [Etot] = E_field_Nop_const(J,fN,Gram,freq,Einc,GPU_flag)
...
% we pass J instead of r, since r in mv_L is only used to get dimensions
[Etot] = mv_L_const(J, fN, J, Gram, idx, GPU_flag);
