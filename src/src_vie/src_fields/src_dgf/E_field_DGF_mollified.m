function [E] = E_field_DGF_mollified(J,Icoord,Ocoord,ko,cutoff)
...
psi = exp(-cutoff./(cutoff-R2)).*(R<cutoff);
...
% compute chi
chi = 1j*omega*mu_o*exp(-1j*ko*R)./(4*pi*ko*ko*R3);
